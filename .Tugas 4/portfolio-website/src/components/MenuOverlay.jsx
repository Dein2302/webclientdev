      ...
      >
        <div className="p-12 h-full flex flex-col">
          ...
          <nav className="flex flex-col space-y-8 mt-32">
            <Link to="/" className="text-[42px] font-medium hover:text-gray-300">
              Home
            </Link>
            <a href="#about" className="text-[42px] font-medium hover:text-gray-300">
              About
            </a>
            <a href="#work" className="text-[42px] font-medium hover:text-gray-300">
              Work
            </a>
            <Link to="/contact" className="text-[42px] font-medium hover:text-gray-300">
              Contact
            </Link>
          </nav>
